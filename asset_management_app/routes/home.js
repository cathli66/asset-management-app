...
exports.advanced_search_result = [get_name, get_type, get_manu, get_price, get_all_ids, function(req, res) {
    // console.log(res.locals.name_array.length);
    // console.log(res.locals.type_array.length);
    // console.log("");
    if (res.locals.name_array.length + res.locals.type_array.length + res.locals.manu_array.length + res.locals.price_array.length > 0) {
        ...
        var id_list = _.intersection(res.locals.name_array, res.locals.type_array, res.locals.manu_array, res.locals.price_array);
        if (!id_list.length) {
